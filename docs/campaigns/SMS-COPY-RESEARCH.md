...
```json
{
  ...
  "promptRules": [
    ...
    "The only variables that exist are {{first_name}}, {{order_count}}, {{last_product}} and {{code}}. Any other placeholder, and any square bracket, angle bracket or single-brace stand-in, is sent to the customer as literal text.",
