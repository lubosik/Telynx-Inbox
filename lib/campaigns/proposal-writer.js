...
function offerFor(mechanism) {
  ...
  return {
    ...
    statedInCopy: false,
    note: 'The drafted message does not state these terms and cannot: a price, a percentage, a code or a deadline fails the copy validator, and the playbook attaches an offer during human review. Set the terms in the store, then in the campaign, before approving anything.'
  };
}
