...
const WINBACK_NAMED = 'It\'s Vin from Vici. {{first_name}}, {{code}} takes 15% off your next '
  + 'order. Stock up on {{last_product}} or try something new. Reply STOP to opt out.';
