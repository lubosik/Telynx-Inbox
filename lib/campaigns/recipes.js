...
// claimable: no coupon is applied automatically, so a message promising 15%
// with no code is a promise the customer cannot act on.
const WINBACK_NAMED = 'It\'s Vin from Vici. Hi {{first_name}}, you ordered {{last_product}} in '
  + '{{last_order_date}}. {{code}} 15% off: {{product_link}} Reply STOP to opt out.';
