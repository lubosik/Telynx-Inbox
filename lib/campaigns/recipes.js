...
const WINBACK_NAMED = 'It\'s Vin from Vici. Hi {{first_name}}, saw you ordered {{last_product}} in '
  + '{{last_order_date}}. Here\'s a code for 15% off your next order: {{code}}. '
  + 'Order here: {{product_link}} Reply STOP to opt out.';

const WINBACK_PLAIN = 'It\'s Vin from Vici. Hi {{first_name}}, saw you ordered from us in '
  + '{{last_order_date}}. Here\'s a code for 15% off your next order: {{code}}. '
