 ...
 */
const WINBACK_NAMED = 'It\'s Vin from Vici. Hi {{first_name}}, thanks for the {{last_product}} '
  + 'order back in {{last_order_date}}. {{code}} is 15% off your next order. Reply STOP to opt out.';

const WINBACK_PLAIN = 'It\'s Vin from Vici. Hi {{first_name}}, thanks for your order back in '
  + '{{last_order_date}}. {{code}} is 15% off your next order. Reply STOP to opt out.';
