...
const COHORTS_NOT_BUILT = Object.freeze([
  ...
  Object.freeze({
    ...
    detail: 'A back in stock cohort needs a recorded out of stock to in stock transition. '
      ...
      + 'this is the CUSTOMER level cohort. The product level pairing of a recorded return with '
      + 'the buyers who are nearly due exists as the automatic segment '
      + 'back_in_stock_nearly_due, and it waits on the same baseline.'
  })
]);
