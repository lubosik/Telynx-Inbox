...
const COHORTS_NOT_BUILT = Object.freeze([
  ...
  Object.freeze({
    ...
    detail: 'A back in stock cohort needs a recorded out of stock to in stock transition. '
      ...
      + 'baseline with scripts/seed-product-inventory-baseline.js before expecting one. Note that '
      + 'this is the CUSTOMER level cohort. The product level views of a recorded return already '
      + 'exist as two disjoint automatic segments, back_in_stock_nearly_due for the buyers who '
      + 'are also nearly due and back_in_stock_other_buyers for the rest of them, and both wait '
