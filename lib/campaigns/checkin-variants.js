 ...
 */
const ANGLES = Object.freeze(['how_it_went', 'open_door']);
...
const ANGLE_PREFERENCE = Object.freeze({
  ...
  first_order: Object.freeze(['open_door', 'how_it_went']),
  conversational: Object.freeze(['how_it_went', 'open_door']),
  // Was ['arrived_ok', 'how_it_went', 'open_door']. A quiet buyer led with the
  // yes-or-no question because it was the cheapest thing to answer. With that
  // angle gone the open door is the gentler of the two that remain: it asks
  // nothing at all, where "how did it go" still wants a sentence back.
  quiet: Object.freeze(['open_door', 'how_it_went'])
});
