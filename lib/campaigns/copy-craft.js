...
const TECHNIQUES = Object.freeze([
  ...
  'Earn the discount. If there is a code, give a reason it exists before giving the code, '
    + 'even a small one. A code with no reason reads as a mass send, which is what it is.',
