 ...
 */
const TEMPLATE = 'Vin from Vici. Hi {{first_name}}, been a while since your {{last_product}} order. '
  + 'Want more sent out? Just say the word. Reply STOP to opt out.';

const TEMPLATE_NO_PRODUCT = 'Vin from Vici. Hi {{first_name}}, been a while since your last order. Want more '
