...
async function converse({
  ...
  const messages = [
    ...
    // latency is what people actually notice.
    ...history.slice(-6),
  ...
  return {
    reply: 'I could not finish working that out. Ask me again in a simpler way.',
    toolsUsed,
...
module.exports = { MAX_TOOL_ROUNDS, SYSTEM_PROMPT, converse };
