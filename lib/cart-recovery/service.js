    ...
    for (const cart of rows || []) {
      ...
      try {
        ...
        try {
          ...
          // A cache miss is safe: the event handler falls back to Telnyx's
          // live ElevenLabs speech command. Never block the recovery journey
          // solely because audio could not be staged before dialing.
          console.warn('[CART VOICE] Pre-generated audio unavailable; using live speech:',
