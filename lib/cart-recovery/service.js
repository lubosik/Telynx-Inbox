...
const { listAccountVoices, speak } = require('../assistant/voice');
...
function createCartRecoveryService({
  ...
  return { processEvent, runDue, runPushDue, runVoiceDue, listRecoveryVoices, previewRecoveryVoice, metrics, preflight, markDelivery, handleInboundReply, handleOptOut, reconcileWooOrder,
