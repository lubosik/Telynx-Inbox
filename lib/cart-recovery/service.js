...
function createCartRecoveryService({
  ...
  async function listRecoveryVoices() {
    ...
    return { voices: curatedRecoveryVoices(voices),
      authorizationBoundary: 'connected_elevenlabs_account_curated_us_professional_clones' };
  }
      ...
      try {
        ...
        try {
          const stagedAudio = await stageVoiceAudio({
            ...
            voiceID: configuration.voiceID, modelID: configuration.modelID,
            synthesize: synthesizeSpeech, env, fetchImpl
          });
