 ...
 *   are five such call sites and there will be more; filtering at the last
 *   boundary means a future sender cannot forget.
 *
 * FIVE CATEGORIES, CLOSED
 ...
 *
 *     NEW WITH THIS TABLE — `daily_digest`. It FAILS CLOSED. It ships with the
 *       migration, so an unreadable preference means the deploy is half done,
...
const CATEGORY_FAILURE_MODE = Object.freeze({
  ...
  missed_calls: 'open',
  // The only one that ships with the table. Nothing to regress.
  daily_digest: 'closed',
